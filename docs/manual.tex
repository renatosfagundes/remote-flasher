...
Botões de configuração rápida permitem colocar todas as placas no mesmo barramento ou dividir em grupos com um clique. Útil para configurar rapidamente cenários de comunicação entre ECUs.
